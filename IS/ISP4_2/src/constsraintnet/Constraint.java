...
public abstract class Constraint implements Cloneable {
	...
	public Constraint(String name, String val1, String val2){
		this.name = name;
		this.val1 = new Type(NameValMapping.map(val1));
		this.val2 = new Type(NameValMapping.map(val1));
	}
	
	public abstract boolean isSatisfied(Type val1, Type val2);
	public abstract boolean isSatisfied(String val1, String val2);
	...
	public Constraint clone() throws CloneNotSupportedException{
		...
		if(!(this instanceof EqualConstraint) && !(this instanceof DifferentConstraint)){
			//System.out.println("Klasse: " + this.toString());
