...
public class Backtracking2 {
	...
	public static void solveNew(ConstraintNet net) throws Exception {
		actualNode = net;
...
//		System.out.println(solution2.get(1) + " " + solution.get(1));
//		System.out.println(solution2.get(2) + " " +solution.get(2));
//		System.out.println(solution2.get(3) + " " +solution.get(3));
//		System.out.println(solution2.get(4) + " " +solution.get(4));
//		System.out.println(solution2.get(5) + " " +solution.get(5));
//		System.out.println(solution2.get(6) + " " +solution.get(6));
	}
		...
		for (Type ti : vi.getDomain()) {
			for (Constraint c : e.getConstraints()) {
				...
				for (Type tj : vj.getDomain()) {
					if((c instanceof DifferentConstraint) || (c instanceof EqualConstraint)){
						if (c.isSatisfied(ti, tj)) {
							...
							//Nur für syso, nichts programmrelevantes
							constraintFail = constraintFail + "-" + c.getName();
						}
					}else {
						if (c.isSatisfied(vi.getName(), vj.getName())) {
							//System.out.println(c.getName() + " is satisfied: " + ti.getElem() + " " + tj.getElem());
							delete_ti = false;
							constraint++;
							break;
