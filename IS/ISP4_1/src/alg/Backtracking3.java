...
//		System.out.println("##############################################");
	...
	private static boolean revise(Edge e) throws Exception {
		...
		for (Type ti : vi.getDomain()) {
			...
			if (/*delete_ti && */constraint != e.getConstraints().size() && log_types_ti > 0) {
