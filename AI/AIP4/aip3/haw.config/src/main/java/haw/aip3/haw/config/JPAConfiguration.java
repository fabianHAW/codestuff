...
@Configuration
@EnableJpaRepositories(basePackages = { AppConfiguration.PKG_PREFIX
		+ ".*.repositories" }, // all Repositories need to be in repositories
								// and need to end with Repository
includeFilters = { @Filter(type = FilterType.REGEX, pattern = "[\\w\\.]*Repository") })
@EnableTransactionManagement
// similiar to <tx:annotation-driven/>
public class JPAConfiguration {

	private static final String ENTITY_BASE = AppConfiguration.PKG_PREFIX
			+ ".*.entities"; // entities need to be in entities
