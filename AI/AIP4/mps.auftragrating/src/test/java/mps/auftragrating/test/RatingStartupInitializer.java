...
@Component
@Transactional
public class RatingStartupInitializer implements ApplicationListener<ContextRefreshedEvent> {
	private static final Logger LOGGER = LoggerFactory.getLogger(RatingStartupInitializer.class);
	...
	private void configure() {
		...
		//IMPORTANT: Do'nt forget to cleanup
