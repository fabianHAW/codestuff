...
public class StartupInitializer implements
	...
	public void configure() {
		...
		System.out.println("Stuecklisten-Positionen initialisieren und Stuecklisten-Positionen 1 holen");
...
//		Set<StuecklistenPosition> posSet1 = getStuecklistenPostionenSet1();
		...
		Stueckliste stueckliste1 = this.produktService.erstelleStueckliste("Steuckliste1", new Date(),
...
//				.getStueckliste("Stueckliste1");
		...
		Arbeitsplan arbeitsplan = this.produktService.erstelleArbeitsplan(vorgaenge);
		//Arbeitsplan arbeitsplan = new Arbeitsplan();
		
		System.out.println("Komplexes Bauteil 1 erzeugen und holen");
		Bauteil b1 = produktService.erstelleKomplexesBauteil("Bauteil1", stueckliste1, arbeitsplan);
		//produktService.erstelleKomplexesBauteil("Bauteil1", stueckliste1, arbeitsplan);
				
		//System.out.println("Komplexes Bauteil 1 holen");
		//Bauteil b1 = produktService.findeBauteil("Bauteil1");
		...
		KundenAuftrag ka1 = this.auftragsService.erzeugeKundenAuftrag(a1/*this.auftragsService.getAngebot(1)*/);

		System.out.println("Fertigungsauftrag 1 erzeugen");
		Fertigungsauftrag fa1 = this.fertigungsService.createFertigungsAuftrag(ka1);
		...
		// 100 days = 8640000000 ms
		Stueckliste stueckliste2 = this.produktService.erstelleStueckliste("Steuckliste2", new Date(),
...
//				.getStueckliste("Stueckliste2");
		...
		Bauteil b2 = produktService.erstelleKomplexesBauteil("Bauteil2", stueckliste2, arbeitsplan);
		
//		System.out.println("Komplexes Bauteil 2 holen");
//		Bauteil b2 = produktService.findeBauteil("Bauteil2");
		...
		Fertigungsauftrag fa2 = this.fertigungsService.createFertigungsAuftrag(ka2);
	...
	private ArrayList<Vorgang> erstelleVorgaenge(){
		...
		vorgangList.add(this.produktService.erstelleVorgang(VorgangArtTyp.MONTAGE, 2000, 3000, 5000));
		vorgangList.add(this.produktService.erstelleVorgang(VorgangArtTyp.BEREITSTELLUNG, 3000, 4000, 6000));
		return vorgangList;
	}
