 ...
 * durch vorgegebene Methoden in accessor_one - ClassOneImplBaseProxy
 * <Sequenzdiagramm client_request> : Realisierung der Sequenznummern 7, 9.1,
 * 10, 11, 13 aus dem Sequenzdiagramm client_request <Sequenzdiagramm
 * client_reply> : Realisierung der Sequenznummern 2.1, 3
 * 
...
public class ClassOneImplBaseProxy extends ClassOneImplBase {
	...
	/**
	 * Verweis zum Entwurf: <Sequenzdiagramm client_request> : Realisierung der
	 * Sequenznummer 9.1
	 * 
	 * @param rawObjRef
	 *            Die Die Objekt-Referenz vom Nameservice.
	 */
	 ...
	 * @param param2
	 *            Irgendein Int
	 * @return new Arraylist<byte[]> Eine Liste aus byte-Arrays der Parameter
	 *         param1 und param2.
	 */
	...
	/**
	 * Verweis zum Entwurf: <Sequenzdiagramm client_reply> Sequenznummer 3
	 * 
	 * @param m
	 *            Die Antwortnachricht.
	 * @return s Der String-R�ckgabewert der methodOne, welcher in der Nachricht
	 *         ist.
	 */
	 ...
	 * @return m2 Die Antwortnachricht, die im CommunicationModuleThread
	 *         gespeichert ist.
	 */
	private MessageADT sendRequest(MessageADT m) {
		...
		synchronized (t) {
			try {
				// Verweis zum Entwurf:
				// <Sequenzdiagramm client_reply> : Realisierung der
				// Sequenznummer 13
				t.wait();
